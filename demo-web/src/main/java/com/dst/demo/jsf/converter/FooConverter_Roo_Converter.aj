...
package com.dst.demo.jsf.converter;

import com.dst.demo.foo.Foo;
import com.dst.demo.jsf.converter.FooConverter;
...
privileged aspect FooConverter_Roo_Converter {
    ...
    declare @type: FooConverter: @FacesConverter("com.dst.demo.jsf.converter.FooConverter");
